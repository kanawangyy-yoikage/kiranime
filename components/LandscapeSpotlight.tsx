      ...
      >
        ...
        {image && (
          <>
            <motion.img
              ...
              animate={{ scale: 1 }}
              transition={{ duration: 1.2, ease: motionTokens.easing.smooth }}
            />
        ...
        <div className="relative z-10 flex items-end justify-between gap-4">
          ...
          <motion.div
            ...
            viewport={{ once: true }}
            transition={{ delay: 0.15, duration: adaptiveDuration(motionTokens.duration.normal), ease: motionTokens.easing.smooth }}
          >
